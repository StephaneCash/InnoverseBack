...
module.exports.transactions = (err) => {
    let errors = { userId: '', motif: '' };

    if (err.message.includes('userId'))
        errors.email = 'Veuillez renseigner un userId';

    if (err.message.includes('motif'))
        errors.password = 'Veuillez renseigner un motif de transfert';
